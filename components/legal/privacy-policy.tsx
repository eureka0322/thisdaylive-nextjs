        ...
        <>
            ...
            <div className="bodytext">
                ...
                <ol>
                    ...
                    <li>
                        Definitive identification of the copyright material that you claim has been infringed and which you wish to have removed from the Site.&nbsp; Providing a complete URL in the body of an email is the best way to help us locate such material quickly.
                    </li>
                    <li>
                        Full information regarding the complainant including:
                        <p></p>
                        <ol style={{listStyleType:'lower-roman'}}>
                            ...
                            <li>
                                A statement that the complainant owns the copyright material or is duly authorised to make this complaint on behalf of an identified copyright owner.
                            </li>
                        </ol>
                    </li>
                    <li>
                        A statement that the information in the notification is accurate to the best of the providers knowledge and belief and that the complainant is authorised to act on behalf of the owner of the claimed copyright material.
                    </li>
                </ol>
                <p>
                ...
                <p style={{width:'150px', margin:'2em auto'}}>
                    Leaders &amp; Company Limited<br/>
                    35,Creek Road<br/>
                    Apapa<br/>
                    Lagos, Nigeria
