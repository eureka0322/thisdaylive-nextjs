...
import NewsletterSignUp from '../components/legal/newsletter-sign-up';
...
export default function NewsletterSignUpPage({nowDateString, breakingNews, latestPosts,  sidebarHtml}: Props) {
  ...
  return (
    <Layout >
      <Head>
        <title>{`Newsletter SignUp - ${CMS_NAME}`}</title>
      </Head>
